...
public class LoginSteps {
    ...
    public void iNavigateToAdminLoginHtmlPage() throws Throwable {
    ...
    public void userLoggedOut() throws InterruptedException {
        webDriver.findElement(By.id("btn-login-page"));
    }

    @Then("^user logged out from admin service$")
    public void adminLoggedOut() throws InterruptedException {
